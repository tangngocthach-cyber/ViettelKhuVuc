...
class AppConfig {
  ...
  static const String urlBaoCaoThuCuoc = '$baseUrl/bao-cao-thu-cuoc.php';
  ...
  static const String apiKhaoSatLuuKetQua = '$baseUrl/api/khao-sat/luu-ket-qua.php';
  ...
  static const String apiToaDoXoa = '$baseUrl/api/toa-do/xoa.php';
